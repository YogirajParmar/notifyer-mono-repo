          ...
          <form onSubmit={handleSignUp} className="space-y-4">
            <div className="w-4/5 mx-auto">
              <input
                ...
                type="text"
                required
                className="w-full p-3 border border-gray-300 rounded-md text-sm focus:border-blue-500 focus:ring-2 focus:ring-blue-500/25"
                value={firstName}
            ...
            <div className="w-4/5 mx-auto">
              ...
              <div className="mt-2 text-xs text-gray-600 space-y-1">
                {["Use 8 or more characters", "Use upper and lower case letters (e.g. Aa)", "Use a number (e.g. 1234)", "Use a symbol (e.g. !@#$)"].map(
                  (requirement, index) => (
